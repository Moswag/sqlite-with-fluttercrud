...
class NoteListState extends State<NoteList>{
          ...
          return Card(
            ...
            child: ListTile(
              ...
              onTap: (){
                ...
                navigateToDetail(this.noteList[positon],"Edit Note");
              },
            ),
  ...
  void _showSnackBar(BuildContext context, String messge){
    final snackBar=SnackBar(content: Text(messge));
